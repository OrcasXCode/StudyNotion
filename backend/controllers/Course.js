...
async function getAllCourses(req,res){
    try{
        ...
        return res.status(500).json({
            success:false,
            msg:"Server error failed to get all courses"
        })
    }
}
...
async function getInstructorCourses(req,res){
    try{
        ...
        return res.status(500).json({
            success:false,
            msg:"Server error failed to get instructor courses"
        })
    }
}
...
async function deleteCourse(req,res){
    try{
        ...
        return res.status(500).json({
            success:false,
            msg:"Server error failed to delete the course"
        })
    }
}
